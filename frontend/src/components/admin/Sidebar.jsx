  ...
  return (
    <>
      ...
      <aside
        ...
        aria-label="Sidebar"
      >
        <div className="h-full px-3 py-4 overflow-y-auto  sidebar bg-gray-50 bg-primary-pink">
          <ul className="space-y-2 font-medium">
            <Link to="/dashboard">
              <li>
                <a
                  href="#"
                  className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-white-800 dark:hover:bg-gray-900 group"
                >
                  <svg
            ...
            <li onClick={handleLogout}>
              {!isLoading ? (
                ...
                >
                  <svg
                    className="flex-shrink-0 w-5 h-5 text-white transition duration-75 dark:white group-hover:text-gray-900 dark:group-hover:text-white"
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 18 16"
                ...
                <div className="flex justify-around items-center">
                  ...
                  <span className="text-white font-bold">Logging out...</span>
                </div>
              )}
            </li>
          </ul>
